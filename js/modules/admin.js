...
class AdminModule {
  ...
  submitPin() {
    ...
    if (isValid) {
      ...
      if (errorMsg) errorMsg.innerText = "Incorrect Code! Hint: Master Code is 910010025123343";
      window.omniStore.logAuditEvent("SECURITY_WARNING", `Failed Admin Master Code attempt entered: '${code}'`);
      window.app.playSound('pop');
      this.enteredPin = "";
      this.updatePinDots();
    }
  ...
  getTabDescription() {
    switch (this.activeTab) {
      ...
      case 'security': return 'Manage Admin Master Code (910010025123343), session security, and review tamper-proof audit logs.';
      default: return '';
    }
  }
    ...
    if (this.activeTab === 'security') {
      return `
        <div class="admin-card">
          ...
          <p class="admin-hint-text">Current Master Secret Code is <strong>910010025123343</strong>. You can update it anytime below.</p>
